...
//      print(data);
  ...
  Future<void> _createExcel() async {
      ...
      if (attendance != null && attendance.isNotEmpty) {
        ...
        sheet
            .getRangeByIndex(1, 1, 1, firstMapLength + 1)
            .cellStyle
            .backColor =
        '#333F4F';
        sheet.getRangeByIndex(1, 1, 1, firstMapLength + 1).merge();
        sheet.getRangeByIndex(15, 2)
          ..setText('Name');
        ...
        sheet.getRangeByIndex(15, 2, 15, 31 + 3)
          ..cellStyle.bold = true;
        sheet
        ...
        sheet
            .getRangeByIndex(16 + attendance.length, 1)
            .text =
        ...
        var logoAsBytes = await rootBundle.load(
